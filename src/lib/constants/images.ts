...
export const SITE_IMAGES = {
  ...
  categories: {
    ...
    "cat-silk": unsplash(SAREE_PHOTOS[1]),
    "cat-cotton": unsplash(SAREE_PHOTOS[3]),
    "cat-banarasi": unsplash(SAREE_PHOTOS[0]),
    "cat-kanjeevaram": unsplash(SAREE_PHOTOS[1]),
    "cat-wedding": unsplash(SAREE_PHOTOS[2]),
    "cat-festive": unsplash(SAREE_PHOTOS[2]),
    "cat-handloom": unsplash(SAREE_PHOTOS[4]),
